...
public class PathUtil {
  ...
  public static String ROOT_PATH = "/www/wwwroot/ass/upload/";
  /**
   * 协会注册登记表
   */
  public static String APPLYPATH_ASSREG = ROOT_PATH + "apply" + File.separator + "AssReg" + File.separator;
  /**
   * 重点立项文件
   */
  public static String APPLYPATH_KEYPROJECT = ROOT_PATH + "apply" + File.separator + "KeyProject" + File.separator;
  /**
   * 申请流程临时目录
   */
  public static String APPLYPATH_TEMPLATE = ROOT_PATH + "apply" + File.separator + "Template" + File.separator;
