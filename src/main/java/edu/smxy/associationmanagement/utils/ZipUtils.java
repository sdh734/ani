...
{
    public String zipFile(final String zipBasePath, final String zipName, final String zipFilePath, final List<String> filePaths, final ZipOutputStream zos) throws IOException {
